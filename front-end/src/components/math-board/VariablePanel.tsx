...
export function VariablePanel({ variables, onRemove }: VariablePanelProps) {
  ...
  return (
    <aside className="fixed bottom-[calc(env(safe-area-inset-bottom)+7.5rem)] left-1/2 z-30 w-[calc(100vw-1.5rem)] max-w-[24rem] -translate-x-1/2 rounded-md border border-white/10 bg-neutral-950/70 p-2 text-white shadow-xl shadow-black/30 backdrop-blur-2xl sm:bottom-4 sm:left-4 sm:w-auto sm:max-w-[calc(100vw-2rem)] sm:translate-x-0">
